...
export default function Home() {
  ...
  return (
   <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id = 'home'>
    ...
    <TextGenerateEffect words={words} className='mb-10' />
    ...
    <motion.div
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/raghav-aggarwal-055801183/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/raghavaggarwal2000/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://leetcode.com/raghavaggarwal2000/"
          target="_blank"
        >
          <TbBrandLeetcode />
        </a>
